...
#   render json: businesses, each_serializer: BusinessSerializer, scope: current_user
# end
...
#   render json: business, serializer: BusinessSerializer, scope: current_user
# end
...
#       reviews_count: business.reviews_count || 0,
#       followers_count: 526,
#       global_feeds_count: feeds.where(feed_type: "global").count,
#       local_feeds_count:  feeds.where(feed_type: "local").count,
